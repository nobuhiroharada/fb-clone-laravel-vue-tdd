...
class FriendsTest extends TestCase
{
    ...
    public function a_friend_id_is_required_for_friend_requests()
    {
        ...
        $reqponseString = json_decode($response->getContent(), true);
        $this->assertArrayHasKey('friend_id', $reqponseString['error']['meta']);
    }

    /** @test */
    public function a_user_and_status_is_required_for_friend_request_response()
    {
        $response = $this->actingAs(factory(\App\User::class)->create(), 'api')
            ->post('/api/friend-request-response', [
                'user_id' => '',
    ...
    /** @test */
    public function a_user_is_required_for_ignoring_a_friend_request_response()
    {
        $response = $this->actingAs(factory(\App\User::class)->create(), 'api')
            ->delete('/api/friend-request-response/delete', [
                'user_id' => '',
